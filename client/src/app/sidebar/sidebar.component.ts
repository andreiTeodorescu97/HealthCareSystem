...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/maps', title: 'Maps', icon: 'nc-icon nc-pin-3', class: '', isRegisterRequired: true },
    { path: '/notifications', title: 'Notifications', icon: 'nc-icon nc-bell-55', class: '', isRegisterRequired: true },
    { path: '/table', title: 'Table List', icon: 'nc-icon nc-tile-56', class: '', isRegisterRequired: true },
    { path: '/typography', title: 'Typography', icon: 'nc-icon nc-caps-small', class: '', isRegisterRequired: true },
    { path: '/upgrade', title: 'Upgrade to PRO', icon: 'nc-icon nc-spaceship', class: 'active-pro', isRegisterRequired: true },
    { path: '/errors', title: 'Errors', icon: 'nc-icon nc-spaceship', class: '', isRegisterRequired: true },
